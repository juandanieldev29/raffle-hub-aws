  ...
  return (
    <div
      className={classNames(
        'secondary-background-color padding margin-bottom rounded-2xl transition-transform grid grid-cols-1 md:grid-cols-3 grid-rows-4 md:grid-rows-8 md:gap-x-8 gap-2 shadow-lg min-h-12',
        {
